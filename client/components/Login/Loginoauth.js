...
function OauthLoading() {
	...
	// const KAKAO_AUTH_URL = `https://kauth.kakao.com/oauth/authorize?client_id=2af87592ef59bb8f2f504dc1544a0a89&redirect_uri=http://localhost:3000/oauthloading&response_type=code`;
